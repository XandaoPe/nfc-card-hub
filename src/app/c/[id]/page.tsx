// src/app/c/[id]/page.tsx (ou onde estiver seu ClientCardPage)
'use client';
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center p-4">
            <div className="w-full max-w-md space-y-6">
                ...
                {/* Card Principal */}
                <div className="bg-slate-900/80 border border-slate-800/80 rounded-3xl p-6 shadow-2xl relative overflow-hidden backdrop-blur-xl">
                    {/* Foto de Perfil */}
